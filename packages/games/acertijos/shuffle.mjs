...
// Elige `count` acertijos del banco sin repetir (baraja todos los índices y toma las
// primeras `count` — una permutación nunca repite) y, dentro de cada uno, baraja el
