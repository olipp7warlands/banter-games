// Cálculo — traducido de QuizGame+makeMath() (prototype/banter.jsx líneas 123-137, 206-247),
...
function renderShell() {
  ...
  root.innerHTML = `
    <div style="padding:18px 18px 26px;color:${C.tinta};">
      <div style="font-family:'Jost',system-ui;font-weight:800;font-size:24px;">Cálculo</div>
      ${chronoHtml(par)}
...
function renderQuestion() {
  ...
  area.innerHTML = `
    ...
    <div style="background:${C.card};border:1px solid ${C.linea};padding:22px 16px;text-align:center;margin-bottom:14px;">
      <div style="font-family:'Jost',system-ui;font-weight:800;font-size:32px;">${q.q}</div>
    </div>
...
window.BanterSDK.onInit((cfg) => {
  ...
  questions = buildMathQuestions(cfg.seed, QUESTIONS_PER_DAY);
