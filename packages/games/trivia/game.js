...
// Crono ascendente + barra + desglose: delegados en packages/games-sdk/hud.js (helper
// compartido, ver comentario ahí). El juego reporta score base y secs en crudo
// (BanterSDK.gameOver(score, {secs})); la API (docs/DB_SCHEMA_M3.sql) calcula y persiste
// el bonus real — el desglose de aquí es solo para mostrarlo un instante antes de terminar.
